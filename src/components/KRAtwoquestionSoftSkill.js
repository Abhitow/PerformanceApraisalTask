...
import KRAsofttextfield2 from './KRAsofttextfield2'
import KRAtextfield from './KRAtextarea'

function KRAtwoquestionSoftSkill() {
  return (
    <div>
        <div>
            <Row>
                <Col>
                    <h3 style={{float:'left',fontSize:'20px'}}>KRA 2: Punctuality in office</h3>
                </Col>
            </Row>
           <Row>
            <Col span={24}>
...
export default KRAtwoquestionSoftSkill