...
import KRAsofttextfield4 from './KRAsofttextfield4'
import KRAtextfield from './KRAtextarea'

function KRAfourquestionSoftSkill() {
  return (
    <div>
        <div>
            <Row>
                <Col>
                    <h3 style={{float:'left',fontSize:'20px'}}>KRA 4: Team Work</h3>
                </Col>
            </Row>
           <Row>
            <Col span={24}>
...
export default KRAfourquestionSoftSkill